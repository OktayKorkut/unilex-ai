...
const sequenceTexts = [
  "UniLex ile Tanışın",
  "Aramaya son",
  "Sayfalarca kaydırmaya son",
  "Kaosu geride bırakın",
  "Tarar. Öğrenir. Günceller.",
  "Sıfır Halüsinasyon",
  "%100 Kaynak Atfı",
  "Varsayımlara yer yok",
  "Sadece saf akademik gerçekler",
];
        ...
        >
          ...
          <Box className={classes.mainContent} ref={mainTitleRef}>
            <Title order={1} className={classes.mainTitle}>
              Bilginin Işığında <br />{" "}
              <span className={classes.highlight}>Akademik Derinlik.</span>
            </Title>
            <Text c="dimmed" size="xl" mt="xl" maw={600} mx="auto" ta="center">
              RAG teknolojisiyle güçlendirilmiş UniLex ile akademik
              kaynaklarınızı saniyeler içinde tarayın, sentezleyin ve bilimsel
              doğrulukla raporlayın.
            </Text>
            <Flex
              justify="center"
              gap="md"
