...
const rootsData = [
  {
    ...
    description: 'Üniversitemizin köklü akademik birikimi, her algoritmanın doğruluğunu denetler.',
    color: '#00bcd4',
  },
  {
    icon: IconMicroscope,
    title: 'İleri Laboratuvarlar',
    description: 'En son GPU teknolojileri ve büyük veri setleri ile modellerimizi eğitiyoruz.',
    color: '#20c997',
  },
  {
    icon: IconUsersGroup,
    title: 'Öğrenci Odaklı',
    description: 'Platformumuzu, gerçek kampüs ihtiyaçlarını analiz ederek öğrencilerimizle birlikte tasarlıyoruz.',
    color: '#9c27b0',
  },
];
...
export default function AboutPage() {
  ...
  return (
    <div ref={containerRef} className={classes.container}>
      ...
      <Container size="md" style={{ textAlign: 'center', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <Box pt={100}>
          <Badge className="hero-element" size="xl" variant="light" color="cyan" mb="xl" radius="sm">
          ...
          <Text className="hero-element" c="gray.4" size="xl" maw={700} mx="auto" mb={40}>
            UniLex AI, araştırmacıların ve öğrencilerin bilgiye erişimini yapay zeka ile dönüştürerek, karmaşık verileri berrak akademik çıktılara dönüştürmeyi misyon edinmiştir.
          </Text>
            ...
            <Card radius="lg" p={{ base: 'md', sm: 'xl' }} className={`bento-card ${classes.gradientCard}`} h="100%">
              ...
              >
                <Box style={{ flex: 1 }}>
                  ...
                  <Title order={3} c="white" mb="sm">Şeffaflık</Title>
                  <Text c="gray.4" size="md">
                    AI'nın akıl yürütme süreçlerini "camdan bir kutu" haline getiriyoruz. Her yanıt, takip edilebilir kaynaklar ve mantıksal bir akışla sunulur.
                  </Text>
                </Box>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card radius="lg" p={{ base: 'md', sm: 'xl' }} className={`bento-card ${classes.gradientCard}`} h="100%">
              <div className={classes.cardContent}>
                ...
                <Title order={3} c="white" mb="sm">Akademik Dürüstlük</Title>
                <Text c="gray.4" size="md" mb="xl">
                  Bilginin doğruluğu ve kaynakların orijinalliği sistemimizin kalbinde yer alır.
                </Text>
                <Badge color="grape" variant="outline">SIFIR HALÜSİNASYON HEDEFİ</Badge>
              </div>
            </Card>
          </Grid.Col>
            ...
            <Card radius="lg" p={{ base: 'md', sm: 'xl' }} className={`bento-card ${classes.gradientCard}`}>
              ...
              >
                <Box style={{ flex: '1 1 300px' }}>
                  ...
                  <Text c="gray.4" size="md" mb="xl">
                    Işık University AI Lab bünyesinde geliştirilen algoritmalarımız, sadece yanıt vermekle kalmaz, akademik merakı teşvik eden yeni perspektifler sunar.
                  </Text>
                  <Group>
                    <Avatar.Group>
                      <Avatar color="cyan" radius="xl">AI</Avatar>
                      <Avatar color="grape" radius="xl">ML</Avatar>
                      <Avatar color="teal" radius="xl">NLP</Avatar>
                    </Avatar.Group>
                    <Text size="sm" c="dimmed">50+ Akademik İşbirliği</Text>
                  </Group>
                </Box>
                ...
                <Box style={{ flex: '1 1 200px', display: 'flex', gap: '1rem', width: '100%' }}>
                  ...
                  <Card bg="rgba(0,0,0,0.3)" p="lg" radius="md" style={{ flex: 1, border: '1px solid rgba(255,255,255,0.05)', textAlign: 'center' }}>
                    <Text size="xl" fw={900} className={classes.glowText} style={{ fontSize: '2rem' }}>24/7</Text>
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing={60} style={{ alignItems: 'center' }}>
          <Box className="rag-content">
            ...
            <Text c="gray.4" size="lg" mb="xl">
              UniLex AI, standart dil modellerinin ötesine geçerek RAG teknolojisini kullanır. Bu sistem AI'nın sadece bildiklerini söylemesini değil, Işık Üniversitesi'nin güvenilir veri tabanlarından anlık bilgi çekerek yanıt oluşturmasını sağlar.
            </Text>

            <List spacing="lg" size="md" center icon={<ThemeIcon color="teal" size={24} radius="xl"><IconCheck size={16} /></ThemeIcon>}>
              <List.Item>
                <Text fw={700} c="white">Gerçek Zamanlı Veri Erişimi</Text>
                <Text c="gray.5" size="sm">En güncel yönetmelikler ve kütüphane kaynakları anında taranır.</Text>
              </List.Item>
              <List.Item>
                <Text fw={700} c="white">Kanıta Dayalı Yanıtlar</Text>
                <Text c="gray.5" size="sm">Her iddia, sistem tarafından doğrulanmış bir akademik kaynağa dayanır.</Text>
              </List.Item>
            </List>
          </Box>
          ...
          <Box className="rag-image" h={{ base: 300, md: 400 }} style={{ position: 'relative' }}>
            <div style={{ position: 'absolute', inset: 0, borderRadius: '24px', background: 'linear-gradient(45deg, rgba(11, 19, 43, 0.5), rgba(0, 188, 212, 0.2))', border: '1px solid rgba(0, 188, 212, 0.3)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ width: '150px', height: '150px', background: 'rgba(0, 188, 212, 0.1)', border: '2px solid #00bcd4', borderRadius: '16px', boxShadow: '0 0 50px rgba(0, 188, 212, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', top: '-50px', width: '2px', height: '50px', background: '#00bcd4', boxShadow: '0 0 10px #00bcd4' }} />
                <div style={{ position: 'absolute', bottom: '-50px', width: '2px', height: '50px', background: '#00bcd4', boxShadow: '0 0 10px #00bcd4' }} />
                <div style={{ position: 'absolute', left: '-50px', width: '50px', height: '2px', background: '#00bcd4', boxShadow: '0 0 10px #00bcd4' }} />
                <div style={{ position: 'absolute', right: '-50px', width: '50px', height: '2px', background: '#00bcd4', boxShadow: '0 0 10px #00bcd4' }} />
              </div>
            </div>
            <Group justify="flex-end" mt="xs" style={{ position: 'absolute', bottom: -15, right: 20 }}>
              <Badge color="gray" variant="outline" bg="#0b132b">Source: IŞIK 2026</Badge>
              <Badge color="gray" variant="outline" bg="#0b132b">Source: Qdrant DB</Badge>
            </Group>
          </Box>
        </SimpleGrid>
      </Container>
        ...
        <Container size="xl">
          ...
          >
            <Box maw={600}>
              ...
              <Text c="gray.4">
                UniLex AI, Işık Üniversitesi AI Lab bünyesinde, akademisyenler ve veri bilimcilerinden oluşan disiplinlerarası bir ekip tarafından geliştirilmiştir.
              </Text>
            </Box>
          ...
          <SimpleGrid cols={{ base: 1, sm: 3 }} spacing="xl">
            {rootsData.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className={classes.cardContent}>
                    <Icon size={32} color={item.color} style={{ marginBottom: '1rem' }} />
                    <Title order={4} c="white" mb="sm">{item.title}</Title>
                    <Text c="gray.5" size="sm">{item.description}</Text>
                  </div>
                </Card>
              );
            })}
